...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/movil/ENPS/aplicacion_mensual.js"></script>
		<script type="text/javascript" src="../js/movil/ENPS/aplicacion_semanal.js"></script>
		<script type="text/javascript" src="../js/movil/ENPS/recurso_mensual.js"></script>
    <script type="text/javascript" src="../js/movil/ENPS/recurso_semanal.js"></script>
	...
	<body>
		...
		<section id="contenedor">
			<div id="submenu"><a href="ENPS.php">Seguimiento</a> | <span class="activo">Informe</span></div>
        ...
        <div id="recurso_mensual" style="width: 50%; height: 500px; margin:1 auto;float:left"></div>
			...
			<div style="width: 50%; float:left"><?php include('../php/movil/ENPS/tabla_semanal.php');?></div>
			<div style="width: 50%; float:left"><?php include('../php/movil/ENPS/tabla_mensual.php');?></div>
