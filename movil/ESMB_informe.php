...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/movil/ESMB/aplicacion_mensual.js"></script>
		<script type="text/javascript" src="../js/movil/ESMB/aplicacion_semanal.js"></script>
		<script type="text/javascript" src="../js/movil/ESMB/recurso_mensual.js"></script>
    <script type="text/javascript" src="../js/movil/ESMB/recurso_semanal.js"></script>
	...
	<body>
        ...
        <div id="recurso_mensual" style="width: 50%; height: 500px; margin:1 auto;float:left"></div>
			...
			<div style="width: 50%; float:left"><?php include('../php/movil/ESMB/tabla_semanal.php');?></div>
			<div style="width: 50%; float:left"><?php include('../php/movil/ESMB/tabla_mensual.php');?></div>
