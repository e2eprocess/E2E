...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/movil/ENPP/aplicacion_mensual.js"></script>
		<script type="text/javascript" src="../js/movil/ENPP/aplicacion_semanal.js"></script>
		<script type="text/javascript" src="../js/movil/ENPP/recurso_mensual.js"></script>
    <script type="text/javascript" src="../js/movil/ENPP/recurso_semanal.js"></script>
	...
	<body>
		...
		<section id="contenedor">
			<div id="submenu"><a href="ENPP.php">Seguimiento</a> | <span class="activo">Informe</span></div>
        ...
        <div id="recurso_mensual" style="width: 50%; height: 500px; margin:1 auto;float:left"></div>
			...
			<div style="width: 50%; float:left"><?php include('../php/movil/ENPP/tabla_semanal.php');?></div>
			<div style="width: 50%; float:left"><?php include('../php/movil/ENPP/tabla_mensual.php');?></div>
