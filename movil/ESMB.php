...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/movil/ESMB/tiempoRespuesta.js"></script>
		<script type="text/javascript" src="../js/movil/ESMB/peticiones.js"></script>
		<script type="text/javascript" src="../js/movil/ESMB/cpu.js"></script>
    <script type="text/javascript" src="../js/movil/ESMB/memoria.js"></script>
	...
	<body>
		...
		<section id="contenedor">
			<div id="submenu"> <span class="activo">Seguimiento </span> | <a href="ESMB_informe.php">Informe</a> </div>
