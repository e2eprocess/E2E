...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/netCash/KYOP/tiempoRespuesta.js"></script>
		<script type="text/javascript" src="../js/netCash/KYOP/peticiones.js"></script>
		<script type="text/javascript" src="../js/netCash/KYOP/cpu.js"></script>
		<script type="text/javascript" src="../js/netCash/KYOP/memoria.js"></script>
	...
	<body>
		...
		<section id="contenedor">
			<div id="submenu"> <span class="activo">Seguimiento</span> | <a href="KYOP_informe.php">Informe</a> </div>
			...
			<div style="width: 50%; float:left"><?php include('../php/netCash/KYOP/tabla_semanal.php');?></div>
			<div style="width: 50%; float:left"><?php include('../php/netCash/KYOP/tabla_mensual.php');?></div>
