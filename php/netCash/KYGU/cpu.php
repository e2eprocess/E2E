<?php
  ...
  if(date("Y-m-d")==$newTo){
    ...
    $apbad026_To = seguimientoCPUHoy('apbad026',$newToF,$newTo,'netcash','KYGU%','CPU');
  }else{
    $apbad022_To = seguimientoCPU('apbad022',$newTo,'netcash','KYGU%','CPU');
    $apbad023_To = seguimientoCPU('apbad023',$newTo,'netcash','KYGU%','CPU');
    $apbad024_To = seguimientoCPU('apbad024',$newTo,'netcash','KYGU%','CPU');
    $apbad026_To = seguimientoCPU('apbad026',$newTo,'netcash','KYGU%','CPU');
  }
  $apbad022_From = seguimientoCPU('apbad022',$newFrom,'netcash','KYGU%','CPU');
  $apbad023_From = seguimientoCPU('apbad023',$newFrom,'netcash','KYGU%','CPU');
  $apbad024_From = seguimientoCPU('apbad024',$newFrom,'netcash','KYGU%','CPU');
  $apbad026_From = seguimientoCPU('apbad026',$newFrom,'netcash','KYGU%','CPU');
