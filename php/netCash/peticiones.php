<?php
  ...
  if(date("Y-m-d")==$newTo){
    ...
    $peticionesHoy = busquedaHoy('kyop_mult_web_kyoppresentation',$newToF,$newTo);

  }
  else {
    $peticionesHoy = busqueda('kyop_mult_web_kyoppresentation',$newTo);

  }
  $peticionesPasada = busqueda('kyop_mult_web_kyoppresentation', $newFrom);
