...
$kyop_mult_web_kyoppresentationTime = tiempo('kyop_mult_web_kyoppresentation',$hoy,'10 days');
$kyop_mult_web_kyoppresentationPeti = peticiones('kyop_mult_web_kyoppresentation',$hoy,'10 days');
