<?php
  ...
  $peticionesHoy = busquedaPeticionesHoy('kyop_mult_web_kyoppresentation',$newToF,$newTo,'Throughput');
  $peticionesPasada = busquedaPeticiones('kyop_mult_web_kyoppresentation', $newFrom,'Throughput');
