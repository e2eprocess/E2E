<?php
  ...
  if(date("Y-m-d")==$newTo){
    ...
    $apbad022_To = seguimientoCPU('apbad022',$newTo,'netcash','KYOP%','CPU');
    $apbad023_To = seguimientoCPU('apbad023',$newTo,'netcash','KYOP%','CPU');
    $apbad024_To = seguimientoCPU('apbad024',$newTo,'netcash','KYOP%','CPU');
    $apbad026_To = seguimientoCPU('apbad026',$newTo,'netcash','KYOP%','CPU');
  }
