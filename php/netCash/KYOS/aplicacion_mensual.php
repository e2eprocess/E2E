...
$serviciosTime = tiempo('kyos_mult_web_servicios',$hoy,'40 days');
$posicioncuentasTime = tiempo('kyos_mult_web_posicioncuentas',$hoy,'40 days');
$serviciosPeti = peticiones('kyos_mult_web_servicios',$hoy,'40 days');
$posicioncuentasPeti = peticiones('kyos_mult_web_posicioncuentas',$hoy,'40 days');
