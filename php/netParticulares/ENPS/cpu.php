<?php
  ...
  while($r1 = mysql_fetch_array($ENPS_701_20_From)) {
        $category['data'][] = $r1['fecha'];
        $series1['data'][] = $r1['cpu'];
      }
  while($r2 = mysql_fetch_array($ENPS_701_21_From)) {
        $series2['data'][] = $r2['cpu'];
      }
  while($r3 = mysql_fetch_array($ENPS_701_22_From)) {
        $series3['data'][] = $r3['cpu'];
      }
  while($r4 = mysql_fetch_array($ENPS_701_30_From)) {
        $series4['data'][] = $r4['cpu'];
      }
  while($r5 = mysql_fetch_array($ENPS_701_31_From)) {
        $series5['data'][] = $r5['cpu'];
      }
  while($r6 = mysql_fetch_array($ENPS_701_32_From)) {
        $series6['data'][] = $r6['cpu'];
      }
  while($r7 = mysql_fetch_array($ENPS_701_40_From)) {
        $series7['data'][] = $r7['cpu'];
      }
  while($r8 = mysql_fetch_array($ENPS_701_41_From)) {
        $series8['data'][] = $r8['cpu'];
      }
  while($r9 = mysql_fetch_array($ENPS_701_42_From)) {
        $series9['data'][] = $r9['cpu'];
      }
  while($r10 = mysql_fetch_array($ENPS_701_60_From)) {
        $series10['data'][] = $r10['cpu'];
      }
  while($r11 = mysql_fetch_array($ENPS_701_61_From)) {
        $series11['data'][] = $r11['cpu'];
      }
  while($r12 = mysql_fetch_array($ENPS_701_62_From)) {
        $series12['data'][] = $r12['cpu'];
      }

  while($r13 = mysql_fetch_array($ENPS_701_20_To)) {
        $series13['data'][] = $r13['cpu'];
      }
  while($r14 = mysql_fetch_array($ENPS_701_21_To)) {
        $series14['data'][] = $r14['cpu'];
      }
  while($r15 = mysql_fetch_array($ENPS_701_22_To)) {
        $series15['data'][] = $r15['cpu'];
      }
  while($r16 = mysql_fetch_array($ENPS_701_30_To)) {
        $series16['data'][] = $r16['cpu'];
      }
  while($r17 = mysql_fetch_array($ENPS_701_31_To)) {
        $series17['data'][] = $r17['cpu'];
      }
  while($r18 = mysql_fetch_array($ENPS_701_32_To)) {
        $series18['data'][] = $r18['cpu'];
      }
  while($r19 = mysql_fetch_array($ENPS_701_40_To)) {
        $series19['data'][] = $r19['cpu'];
      }
  while($r20 = mysql_fetch_array($ENPS_701_41_To)) {
        $series20['data'][] = $r20['cpu'];
      }
  while($r21 = mysql_fetch_array($ENPS_701_42_To)) {
        $series21['data'][] = $r21['cpu'];
      }
  while($r22 = mysql_fetch_array($ENPS_701_60_To)) {
        $series22['data'][] = $r22['cpu'];
      }
  while($r23 = mysql_fetch_array($ENPS_701_61_To)) {
        $series23['data'][] = $r23['cpu'];
      }
  while($r24 = mysql_fetch_array($ENPS_701_62_To)) {
