<?php
  ...
  if(date("Y-m-d")==$newTo){
    ...
    $BBVANetHoy = busquedaHoy('kqof_es_web_BBVANet_01',$newToF,$newTo);
  }
  else {
    $BBVANetHoy = busqueda('kqof_es_web_BBVANet_01',$newTo);
  }
  $BBVANetPasada = busqueda('kqof_es_web_BBVANet_01',$newFrom);
  ...
  while($r3 = mysql_fetch_array($BBVANetHoy)) {
