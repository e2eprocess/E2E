<?php
  ...
  $gtHoy = busquedaPeticionesHoy('GTmobile',$newToF,$newTo, 'Throughput');
  $servicioHoy = busquedaPeticionesHoy('ASOmobile',$newToF,$newTo, 'Throughput');

  $gtPasada = busquedaPeticiones('GTmobile', $newFrom, 'Throughput');
  $servicioPasada = busquedaPeticiones('ASOmobile', $newFrom, 'Throughput');
