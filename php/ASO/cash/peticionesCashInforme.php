<?php
  ...
  $gtHoy = busquedaPeticionesHoy('GTnetcash',$newToF,$newTo, 'Throughput');
  $servicioHoy = busquedaPeticionesHoy('ASOnetcash',$newToF,$newTo, 'Throughput');

  $gtPasada = busquedaPeticiones('GTnetcash', $newFrom, 'Throughput');
  $servicioPasada = busquedaPeticiones('ASOnetcash', $newFrom, 'Throughput');
