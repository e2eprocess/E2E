...
<html>
	<head>
		...
		<script type="text/javascript" src="js/movil/tiempoRespuesta.js"></script>
		<script type="text/javascript" src="js/movil/peticiones.js"></script>
		<script type="text/javascript" src="js/movil/cpu.js"></script>
