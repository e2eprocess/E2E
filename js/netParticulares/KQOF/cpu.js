$(document).ready(function() {
  var options = {
          ...
          /*series: []*/
          series: [{
            name: 'CPU-apbad002_kqof_701_20 (F)',
            color: 'rgba(4,38,253,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad002_kqof_701_21 (F)',
            color: 'rgba(4,129,255,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad002_kqof_701_22 (F)',
            color: 'rgba(49,4,247,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad003_kqof_701_30 (F)',
            color: 'rgba(95,173,251,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad003_kqof_701_31 (F)',
            color: 'rgba(80,209,250,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad003_kqof_701_32 (F)',
            color: 'rgba(49,4,247,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad004_kqof_701_40 (F)',
            color: 'rgba(4,38,253,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad004_kqof_701_41 (F)',
            color: 'rgba(4,129,255,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad004_kqof_701_42 (F)',
            color: 'rgba(49,4,247,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad006_kqof_701_60 (F)',
            color: 'rgba(95,173,251,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad006_kqof_701_61 (F)',
            color: 'rgba(80,209,250,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad006_kqof_701_62 (F)',
            color: 'rgba(49,4,247,1)',
            type: 'column',
            data:[]
          },{
            name: 'CPU-apbad002_kqof_701_20 (T)',
            color: 'rgba(4,38,253,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad002_kqof_701_21 (T)',
            color: 'rgba(4,129,255,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad002_kqof_701_22 (T)',
            color: 'rgba(49,4,247,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad003_kqof_701_30 (T)',
            color: 'rgba(95,173,251,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad003_kqof_701_31 (T)',
            color: 'rgba(80,209,250,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad003_kqof_701_32 (T)',
            color: 'rgba(49,4,247,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad004_kqof_701_40 (T)',
            color: 'rgba(4,38,253,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad004_kqof_701_41 (T)',
            color: 'rgba(4,129,255,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad004_kqof_701_42 (T)',
            color: 'rgba(49,4,247,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad006_kqof_701_60 (T)',
            color: 'rgba(95,173,251,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad006_kqof_701_61 (T)',
            color: 'rgba(80,209,250,1)',
            type: 'line',
            data:[]
          },{
            name: 'CPU-apbad006_kqof_701_62 (T)',
            color: 'rgba(49,4,247,1)',
            type: 'line',
            data:[]
          }]
      ...
      $.getJSON("../php/netParticulares/KQOF/cpu.php", function(json) {
