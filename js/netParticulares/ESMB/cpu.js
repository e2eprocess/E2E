$(document).ready(function() {
  var options = {
          ...
          /*series: []*/
          series: [{
            name: 'apbad002_ESMB (F)',
            color: 'rgba(4,38,253,1)',
            type: 'column',
            data:[]
          },{
            name: 'apbad003_ESMB (F)',
            color: 'rgba(4,129,255,1)',
            type: 'column',
            data:[]
          },{
            name: 'apbad004_ESMB (F)',
            color: 'rgba(49,4,247,1)',
            type: 'column',
            data:[]
          },{
            name: 'apbad006_ESMB (F)',
            color: 'rgba(95,173,251,1)',
            type: 'column',
            data:[]
          },{
            name: 'apbad002_ESMB (T)',
            color: 'rgba(4,38,253,1)',
            type: 'line',
            data:[]
          },{
            name: 'apbad003_ESMB (T)',
            color: 'rgba(4,129,255,1)',
            type: 'line',
            data:[]
          },{
            name: 'apbad004_ESMB (T)',
            color: 'rgba(49,4,247,1)',
            type: 'line',
            data:[]
          },{
            name: 'apbad006_ESMB (T)',
            color: 'rgba(95,173,251,1)',
            type: 'line',
            data:[]
          }]
      ...
      $.getJSON("/E2E/php/netParticulares/ESMB/cpu.php", function(json) {
