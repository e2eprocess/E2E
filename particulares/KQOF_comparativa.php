...
<html>
    ...
    <script type="text/javascript" src="/E2E/js/netParticulares/KQOF/memoria.js"></script>
	...
	<body>
		...
		<section id="contenedor">
			<div id="submenu"> <span class="activo">Comparativa</span> | <a href="KQOF_informe.php">Informe</a> </div>
