...
<html>
	...
	<body>
        ...
        <div id="recurso_mensual" style="width: 50%; height: 500px; margin:1 auto;float:left"></div>
			...
			<div style="width: 50%; float:left"><?php include('../php/particulares/KQOF/tabla_semanal.php');?></div>
			<div style="width: 50%; float:left"><?php include('../php/particulares/KQOF/tabla_mensual.php');?></div>
