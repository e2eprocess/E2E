...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/particulares/ENPS/aplicacion_mensual.js"></script>
		<script type="text/javascript" src="../js/particulares/ENPS/aplicacion_semanal.js"></script>
		<script type="text/javascript" src="../js/particulares/ENPS/recurso_mensual.js"></script>
    <script type="text/javascript" src="../js/particulares/ENPS/recurso_semanal.js"></script>
